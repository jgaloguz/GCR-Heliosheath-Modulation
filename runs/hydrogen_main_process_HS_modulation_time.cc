...
int main(int argc, char** argv)
{
   ...
   std::string distroname1 = "../results/HS_mod_spec_H/HS_mod_parker_" + std::to_string(percent) + "_pct_1.out";
   std::string infilename1 = "../results/HS_mod_spec_H/HS_mod_parker_" + std::to_string(percent) + "_pct_time.dat";
   std::string outfilename = "../results/HS_mod_spec_H/HS_mod_parker_" + std::to_string(percent) + "_pct_time_pp.dat";
   std::string line;
   int i, N = 100;
