...
const double ds = 1.0;
const int specie = Specie::electron;
...
int main(int argc, char** argv)
{
   ...
   std::string distroname1 = "../results/HS_mod_spec_e/HS_mod_parker_" + std::to_string(percent) + "_pct_0.out";
   std::string infilename1 = "../results/HS_mod_spec_e/HS_mod_parker_" + std::to_string(percent) + "_pct_spec.dat";
   std::string outfilename = "../results/HS_mod_spec_e/HS_mod_parker_" + std::to_string(percent) + "_pct_spec_comp.dat";
   std::string line;
   int i, N = 100;
   int sum_c1[N];
