...
int main(int argc, char** argv)
{
   ...
   std::string outfilename = "../results/HS_mod_spec_e/HS_mod_parker_integ_spec.dat";
...
// Open input differential intensity file
      infilename = "../results/HS_mod_spec_e/HS_mod_parker_" + std::to_string(percent) + "_pct_spec_comp.dat";
